...
class Inventario:
    ...
    def cargar_inventario(self):
        try:
            with open('Inventario.text', 'r') as file:
                for line in file:
            ...
            print("Archivo no encontrado. Se creará un nuevo archivo de inventario.")
            open('Inventario.text', 'w').close()
        except Exception as e:
            print(f"Ocurrió un error al cargar el inventario: {e}")

    def guardar_inventario(self):
        try:
            with open('Inventario.text', 'w') as file:
                for producto in self.productos:
                    file.write(
                        f'{producto.get_id_producto()},{producto.get_nombre()},{producto.get_cantidad()},{producto.get_precio()}\n')
        except Exception as e:
